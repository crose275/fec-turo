  ...
  return (
    <div className='AllStarModal'>
      ...
      <div className='ImageContainer'>
        <img className='AllStarBadgeIcon' src='https://images.squarespace-cdn.com/content/v1/5e83804992ec7778163264a4/1588468065560-K2Z25B36LE74E9J4URUA/All-star-host-badge.png'></img>
      </div>
