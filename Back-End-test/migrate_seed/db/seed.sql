...
INSERT INTO users(user_name, user_password, user_email, user_age, user_profile_pic)
   VALUES ('Sam', 'password' , 'sam.fake@gmail.com', 23, 'https://turoimages.s3.us-east-2.amazonaws.com/User+Profile+Pics/Sam.jpg');
...
INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy,  review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'This was our first time using Turo but definitely won’t be our last! I just hope every experience is as great as this one. Carima greeted us at the airport terminal when we arrived and met us at the terminal when we were flying out. It absolutely could not have been any easier. The Jeep was in perfect condition and a lot of fun! 5 stars is not enough for this experience!', '2023-04-01', NULL, 1, 1);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Thank you and it was great to meet you', '2023-03-21', 'It was a joy to Host you', 1, 2);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Extremely friendly, very nice looking jeep! Super clean and comfortable too!', '2023-02-27', NULL, 1, 3);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Extremely convenient curbside pick-up and drop-up at the airport, warmly greeted by Carima after a long flight. The Jeep is also a joy to drive too.', '2023-01-10', NULL, 1, 4);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Carima’s car was very clean and comfortable to drive for my California roadtrip. Communication with Carima was seamless and she has been an excellent and helpful host. I 100% recommend her!', '2022-10-20', 'Thank you so much, it was a joy to provide your transportation needs, I hope your birthday was memorable.', 1, 5);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Great car, great host!! Thanks Carima & Paul!!', '2022-10-27', 'Communication was awesome, conversation, and the kindness you give is breathtaking. Vehicle returned in the outstanding condition, it was a pleasure to provide your transportation needs', 1, 6);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Rent this car from Carima ASAP! She is the best host ever…felt like we just borrowed our friends car…comfortable, easy, perfect communication, extremely clean car, and just overall extraordinary service! Carima, you are wonderful, thank you so much!', '2022-09-05', 'Thank you for your kind words, we strive to provide exceptional service, so you can focus on creating memories xoxoxox You’re to kind', 1, 7);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5,'Carima made this rental incredible easy. It was my first rental on Turo and because of her it was a great one! The Jeep I rented was clean and in great shape. It did well on the road too! Bonus: Carima kept the communication open during my rental period; making sure everything was well. I will definitely be renting from her again!', '2022-08-21', 'It was a absolute pleasure to have met you both, and provide your first Turo rental experience. We truly appreciate your energy and meaningful conversation. If I could give you a 10 I would wishing you nothing but success with your future travels and business ventures, I’m overly excited for you, reach for the stars Carima and Paul', 1, 8);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'What a great experience! Thank you Carima for the warm welcome to the beautiful west coast! The process was seamless and set the tone for the rest of our trip. Thank you, thank you, thank you !!!', '2022-08-17', 'I had the pleasure to host Fionnuala and her two beautiful friends, they are such amazing individuals with awesome personalities. Wonderful energy, great communication, empathetic, and kind. I will always be available to assist you in anyway, until next time. Carima', 1, 9);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5,'The car was amazing, totally spotless, and so much fun to drive. Carmina made the pickup and drop off process completely seamless and couldn’t have been easier.', '2022-08-03', NULL, 1, 10);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Since this was my first trip using Turo, I was a little nervous how it would go. Carima made it so easy! She was easy to talk to, answered all of our questions, and even adjusted the drop off location to better serve us since we had plans that were going to run a little later than initially planned. We will definitely use Turo again, but if we are ever in San Francisco again, we will definitely go through Carima!', '2022-07-28', 'The greatest gift we could give is flexibility, when traveling many situations can arise, we implement Understanding, empathy, patience, and anticipation of changes. Our goal is to provide a seamless experience, where you can focus on creating memories. Sarah, it was a joy to have met you, and your fantastic family, safe travels and we’re always at your service when in California. Warm regards', 1, 11);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Carima is a delight and so easy to work with. Very smooth process at pickup and drop off. Wonderful!', '2022-07-17', NULL, 1, 12);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Carima was absolutely fantastic! Pickup was a breeze at baggage claim at Oakland International! We dropped off a couple hours earlier than expected and Carima was totally understanding! Would recommend Carima to everyone!', '2022-06-13', NULL, 1, 13);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Carima was a great host and the Jeep was perfect for our trip!', '2022-06-09', NULL, 1, 14);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'The host cancelled this trip 56 minutes before it started. This message was automatically posted by Turo.', '2022-06-02', NULL, 1, 15);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Great trip—the Jeep was well kept and very fun on our trip up the California/Oregon coast. Carima was warm and very thoughtful. Looking forward to renting from Carima for my next trip :)', '2022-05-21', NULL, 1, 16);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'I WANT TO BOOK AGAIN ALREADY! Carima and Paul were phenomenal host! Great communication! Waited on us at pick up and drop off! LOVE their jeep! Can’t wait to book with them again 🥂', '2022-05-03', 'It was awesome to HOST a HOST! We’ll definitely rent your vehicle’s when we visit Atlanta. We appreciated everyone’s energy, entrepreneurial mindset/lifestyle, communication, and promptness with time, safe travel’s ✈️ blessings always til we meet again. Paul and Carima', 1, 17);  

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Carima and her husband are great hosts. They took a lot of time to teach me how to use the removable roof', '2022-04-04', NULL, 1, 18);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy,review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Excellent!!!! Our trip was amazing, Carima and Paul were absolutely amazing. Thanks', '2022-03-25', NULL, 1, 19);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Absolutely amazing! Carima and Paul were so accommodating. The Jeep was clean, smelled amazing, and mechanically sound. Everything was so smooth, and Carima is the SWEETEST person. 10/10 recommend. I cannot say enough great things.', '2022-02-22', NULL, 1, 20);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Carima and Paul are excellent hosts. Thoughtful (a care package with essentials for traveling these days), prompt, professional but warm. The jeep was a joy to drive! I’ve thought of buying one in the past but opted for a pickup… after driving theirs I’m seriously considering one again. Thank you Carima and Paul!', '2022-02-15', NULL, 1, 21);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'The Jeep was Great and very clean when we picked it up. Also Carima was very pleasant and thoughtful. Will rent from them again.', '2021-12-28', 'It was such a joy to meet you both, I hope your trip was epic and memorable, we enjoyed your great conversation, awesome communication, keep creating memories always, Carima and Paul', 1, 22); 

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'The car was clean and sanitized, she has great communication and she was beyond accommodating we had the car 43 days as we waited for our new car to come in.', '2021-12-18', 'Aww 🥰 thank you so much, it was a absolute joy to have met you. Hope we run into each other around town xoxoxox happy holidays Carima', 1, 23);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Carima and Paul were very communicative and helpful. I changed my trip plans mid-trip and they were ok with it. And the jeep was very clean and ran great. This was a great rental!', '2021-10-23', NULL, 1, 24);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Fun car and nice people', '2021-10-04', 'Thank you, it was a pleasure to host you and your father.', 1, 25);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Carima, was the greatest! Responded quickly to all my questions and was very helpful for whatever I needed to make my 8yr wedding anniversary the best weekend.. I highly recommend her with out a doubt l. Thank you again so much Carima.', '2021-09-19', 'Awwww, it was a absolute pleasure to host you, thanks again, for great conversation with your family and being prompt with time, we truly appreciate you', 1, 26);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Carima was such a gracious host; she was so kind and her car was SO FUN!!', '2021-09-05', 'Awwww 🥰 i appreciate you ❤️', 1, 27);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Super easy to use Carmina’s Jeep from SFO! Clean car, great communication. Will rent again.', '2021-09-04', NULL, 1, 28);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'First time using the app and Carima was everything GREAT! On time, communication was great and absolutely the best!', '2021-08-23', '🥰 I truly appreciate you, you’re awesome 🤩', 1, 29);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Carima is an exceptional host. She goes above and beyond to make sure that the customer has a good experience. Communication with her is always pleasant and prompt. The Jeep was super clean and a pleasure to drive. Next time I visit the Bay area she will be my first stop for a vehicle! Thanks Carima!', '2021-08-19', NULL, 1, 30);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Car was perfect and communication was super easy throughout.', '2021-08-08', NULL, 1, 31);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy,review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'The host cancelled this trip 14 hours before it started. This message was automatically posted by Turo.', '2021-07-30', NULL, 1, 15);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'This was my first time using Turo wow what a great experience so easy and convenient', '2021-07-18', 'We’re glad, you had a awesome experience. It was a absolute pleasure providing your transportation needs. Hope to be a future host to you.', 1, 32);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'The Jeep is amazing!! Perfect amount of room for the family and luggage. We enjoyed driving up the San Francisco & Oakland Hills. Communication with Carima was a breeze, and she answered all questions about the area quickly and with a sense of urgency. A true professional, but she also felt like a friend. The Jeep was clean, well maintained, and surprisingly great with gas mileage! Thank you so much! I’d recommend renting from Carima to my friends and family in a heartbeat, and will be requesting for her Jeep when we’re back in town!', '2021-07-14', 'Thank you, so much. It was a absolute joy, hosting you and your family, i appreciate, your feedback on our welcome kits, your awesome communication, and prompt timing for retrieving and returning your vehicle curbside. Thank you, for the auxiliar cord, safe travels and hope to host you again in the future, warm regards Carima', 1, 33);

INSERT INTO reviews(review_rating_cleanliness, review_rating_maintainence, review_rating_communication, review_rating_convenience, review_rating_accuracy, review_message, review_date, review_host_response, car_id, user_id)
   VALUES (5, 5, 5, 5, 5, 'Excellent vehicle, service, met very nice couple .. looking forward to renting with them again..', '2021-07-07', 'Ramesh, and his family, are extremely kind and considerate. Communication, was amazing. It was a pleasure to provide them with transportation', 1, 34);
